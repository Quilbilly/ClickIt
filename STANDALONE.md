# Standalone ClickIt repository

This repository is the standalone ClickIt project. It was extracted from the nested `clickit/` folder in `Quilbilly/chuckneeedham` at commit `d4a47e6`.
